...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/Music_Forever_X')
        ],
        [
...
@Client.on_message(filters.command(["shelp", f"help@{Config.BOT_USERNAME}"]))
...
@Client.on_message(filters.command(['srestart', 'supdate', f"restart@{Config.BOT_USERNAME}", f"update@{Config.BOT_USERNAME}"]) & admin_filter & chat_filter)
...
@Client.on_message(filters.command(['slogs', f"logs@{Config.BOT_USERNAME}"]) & admin_filter & chat_filter)
